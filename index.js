...
/* harmony import */ var _queried_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./queried-data */ "./packages/core-data/build-module/queried-data/index.js");
...
var _marked =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(editEntityRecord),
    _marked2 =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(undo),
    _marked3 =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(redo),
    _marked4 =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(saveEntityRecord),
    _marked5 =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(saveEditedEntityRecord);
...
function receiveUserQuery(queryID, users) {
  return {
    ...
    users: Object(lodash__WEBPACK_IMPORTED_MODULE_4__["castArray"])(users),
    queryID: queryID
  };
}
/**
...
function receiveEntityRecords(kind, name, records, query) {
  ...
  var recordsArray = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["castArray"])(records); // Auto drafts should not have titles, but some plugins rely on them so we can't filter this
  // on the server.

  if (kind === 'postType') {
    records = recordsArray.map(function (record) {
      return record.status === 'auto-draft' ? Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, record, {
        title: ''
      }) : record;
    });
  }
  ...
  if (query) {
    action = recordsArray.length === 1 ? Object(_queried_data__WEBPACK_IMPORTED_MODULE_5__["receiveQueriedItem"])(recordsArray[0], query) : Object(_queried_data__WEBPACK_IMPORTED_MODULE_5__["receiveQueriedItems"])(recordsArray, query);
  } else {
    action = recordsArray.length === 1 ? Object(_queried_data__WEBPACK_IMPORTED_MODULE_5__["receiveItem"])(recordsArray[0], query) : Object(_queried_data__WEBPACK_IMPORTED_MODULE_5__["receiveItems"])(recordsArray, query);
  }
...
function editEntityRecord(kind, name, recordId, edits) {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function editEntityRecord$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          options = _args.length > 4 && _args[4] !== undefined ? _args[4] : {};
          _context.next = 3;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getEntity', kind, name);
        ...
        case 6:
          ...
          _context.next = 9;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getRawEntityRecord', kind, name, recordId);

        case 9:
          record = _context.sent;
          _context.next = 12;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getEditedEntityRecord', kind, name, recordId);
        ...
        case 12:
          ...
          edit = {
            ...
            edits: Object.keys(edits).reduce(function (acc, key) {
              ...
              var value = mergedEdits[key] ? Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, editedRecordValue, edits[key]) : edits[key];
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["isEqual"])(recordValue, value) ? undefined : value;
              return acc;
            }, {}),
            transientEdits: transientEdits
          };
          return _context.abrupt("return", Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({
            type: 'EDIT_ENTITY_RECORD'
          }, edit, {
            meta: {
              undo: !options.undoIgnore && Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, edit, {
...
function undo() {
  var undoEdit;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function undo$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getUndoEdit');
        ...
        case 5:
          _context2.next = 7;
          return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({
            type: 'EDIT_ENTITY_RECORD'
          }, undoEdit, {
            meta: {
              isUndo: true
...
function redo() {
  var redoEdit;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function redo$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getRedoEdit');
...
function saveEntityRecord(kind, name, record) {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function saveEntityRecord$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          entity = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["find"])(entities, {
            kind: kind,
            name: name
          });
        ...
        case 7:
          entityIdKey = entity.key || _entities__WEBPACK_IMPORTED_MODULE_6__["DEFAULT_ENTITY_KEY"];
        ...
        case 10:
          ...
          _Object$entries$_i = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_Object$entries[_i], 2), key = _Object$entries$_i[0], value = _Object$entries$_i[1];
        ...
        case 16:
          ...
          _context4.next = 20;
          return editEntityRecord(kind, name, recordId, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, key, evaluatedValue), {
            undoIgnore: true
          });
        ...
        case 30:
          ...
          _context4.next = 34;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getCurrentUser');

        case 34:
          currentUser = _context4.sent;
          currentUserId = currentUser ? currentUser.id : undefined;
          _context4.next = 38;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getAutosave', persistedRecord.type, persistedRecord.id, currentUserId);
        ...
        case 38:
          ...
          // have a value.
          data = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, persistedRecord, autosavePost, record);
          data = Object.keys(data).reduce(function (acc, key) {
            if (['title', 'excerpt', 'content'].includes(key)) {
              // Edits should be the "raw" attribute values.
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["get"])(data[key], 'raw', data[key]);
            }
        ...
        case 43:
          ...
          newRecord = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, persistedRecord, data, updatedRecord);
          newRecord = Object.keys(newRecord).reduce(function (acc, key) {
            // These properties are persisted in autosaves.
            if (['title', 'excerpt', 'content'].includes(key)) {
              // Edits should be the "raw" attribute values.
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["get"])(newRecord[key], 'raw', newRecord[key]);
            } else if (key === 'status') {
              ...
              acc[key] = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["get"])(persistedRecord[key], 'raw', persistedRecord[key]);
            }
        ...
        case 55:
          ...
          if (kind === 'postType' && persistedRecord && persistedRecord.status === 'auto-draft') {
            if (!_data.status) {
              _data = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, _data, {
                status: 'draft'
              });
            }
          ...
          */
          ...
          _context4.next = 59;
          return receiveEntityRecords(kind, name, Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, _data), undefined, true);
        ...
        case 72:
          ...
          _context4.t7 = _babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"];
          _context4.t8 = {};
          _context4.t9 = currentEdits;
          _context4.next = 81;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getEntityRecordEdits', kind, name, recordId);

        case 81:
          _context4.t10 = _context4.sent;
          _context4.t11 = (0, _context4.t7)(_context4.t8, _context4.t9, _context4.t10);
          _context4.t12 = {
            undoIgnore: true
          };
          _context4.next = 86;
          return (0, _context4.t3)(_context4.t4, _context4.t5, _context4.t6, _context4.t11, _context4.t12);
...
function saveEditedEntityRecord(kind, name, recordId, options) {
  var edits, record;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function saveEditedEntityRecord$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('hasEditsForEntityRecord', kind, name, recordId);
        ...
        case 4:
          _context5.next = 6;
          return Object(_controls__WEBPACK_IMPORTED_MODULE_7__["select"])('getEntityRecordNonTransientEdits', kind, name, recordId);

        case 6:
          edits = _context5.sent;
          record = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({
            id: recordId
          }, edits);
...
function receiveAutosaves(postId, autosaves) {
  return {
    ...
    postId: postId,
    autosaves: Object(lodash__WEBPACK_IMPORTED_MODULE_4__["castArray"])(autosaves)
  };
}
...
/*!************************************************************!*\
  !*** ./packages/core-data/build-module/entity-provider.js ***!
  \************************************************************/
/*! exports provided: default, useEntityId, useEntityProp, __experimentalUseEntitySaving, useEntityBlockEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "__experimentalUseEntitySaving", function() { return __experimentalUseEntitySaving; });
...
var entities = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_2__["default"])({}, _entities__WEBPACK_IMPORTED_MODULE_6__["defaultEntities"].reduce(function (acc, entity) {
  if (!acc[entity.kind]) {
    acc[entity.kind] = {};
  }

  acc[entity.kind][entity.name] = {
    context: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createContext"])()
  };
  return acc;
}, {}), _entities__WEBPACK_IMPORTED_MODULE_6__["kinds"].reduce(function (acc, kind) {
  acc[kind.name] = {};
  return acc;
}, {}));
...
function EntityProvider(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(Provider, {
    value: id
  }, children);
}
/**
...
function useEntityId(kind, type) {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useContext"])(getEntity(kind, type).context);
}
/**
...
function useEntityProp(kind, type, prop) {
  ...
  var _useDispatch = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__["useDispatch"])('core'),
      editEntityRecord = _useDispatch.editEntityRecord;

  var setValue = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function (newValue) {
...
function __experimentalUseEntitySaving(kind, type, props) {
  ...
  var _useSelect = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__["useSelect"])(function (select) {
    ...
    return [props ? editKeys.some(function (key) {
      ...
      _useSelect2 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useSelect, 3),
      isDirty = _useSelect2[0],
      isSaving = _useSelect2[1],
      _select = _useSelect2[2];

  var _useDispatch2 = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__["useDispatch"])('core'),
      saveEntityRecord = _useDispatch2.saveEntityRecord;

  var save = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function () {
    ...
    if (typeof props === 'string') {
      filteredEdits = Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, props, filteredEdits[props]);
    } else if (props) {
    ...
    saveEntityRecord(kind, type, Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_2__["default"])({
      id: id
    }, filteredEdits));
...
function useEntityBlockEditor(kind, type) {
  ...
  var _useDispatch3 = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__["useDispatch"])('core'),
      editEntityRecord = _useDispatch3.editEntityRecord;

  var id = useEntityId(kind, type);
  var initialBlocks = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useMemo"])(function () {
    if (initialEdits) {
    ...
    if (typeof content !== 'function') {
      var parsedContent = Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__["parse"])(content);
  ...
  var onChange = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function (nextBlocks) {
    ...
    setContent(function (_ref3) {
      ...
      return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__["serialize"])(blocksToSerialize);
    });
  }, [onInput, setContent]);
...
/*!**************************************************!*\
  !*** ./packages/core-data/build-module/index.js ***!
  \**************************************************/
/*! exports provided: EntityProvider, useEntityId, useEntityProp, __experimentalUseEntitySaving, useEntityBlockEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _entity_provider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./entity-provider */ "./packages/core-data/build-module/entity-provider.js");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "__experimentalUseEntitySaving", function() { return _entity_provider__WEBPACK_IMPORTED_MODULE_9__["__experimentalUseEntitySaving"]; });
...
/*!*****************************************************************!*\
  !*** ./packages/core-data/build-module/queried-data/actions.js ***!
  \*****************************************************************/
/*! exports provided: receiveItems, receiveItem, receiveQueriedItems, receiveQueriedItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "receiveQueriedItem", function() { return receiveQueriedItem; });
/* harmony import */ var _babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/objectSpread */ "./node_modules/@babel/runtime/helpers/esm/objectSpread.js");
...
function receiveQueriedItem(item) {
  var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, receiveItem(item), {
    query: query
  });
}
...
/*!***************************************************************!*\
  !*** ./packages/core-data/build-module/queried-data/index.js ***!
  \***************************************************************/
/*! exports provided: receiveItems, receiveItem, receiveQueriedItems, receiveQueriedItem, getQueriedItems, reducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "receiveItem", function() { return _actions__WEBPACK_IMPORTED_MODULE_0__["receiveItem"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "receiveQueriedItem", function() { return _actions__WEBPACK_IMPORTED_MODULE_0__["receiveQueriedItem"]; });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils */ "./packages/core-data/build-module/utils/index.js");
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../entities */ "./packages/core-data/build-module/entities.js");
/* harmony import */ var _get_query_parts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./get-query-parts */ "./packages/core-data/build-module/queried-data/get-query-parts.js");
...
function items() {
  ...
  var key = action.key || _entities__WEBPACK_IMPORTED_MODULE_5__["DEFAULT_ENTITY_KEY"];

  switch (action.type) {
    case 'RECEIVE_ITEMS':
      return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, action.items.reduce(function (accumulator, value) {
        var itemId = value[key];
        accumulator[itemId] = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["conservativeMapItem"])(state[itemId], value);
        return accumulator;
      }, {}));
    ...
    case 'RECEIVE_ITEM':
      ...
      var itemId = item[key];
      return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, itemId, Object(_utils__WEBPACK_IMPORTED_MODULE_4__["conservativeMapItem"])(state[itemId], item)));
  }
...
// an unhandled action.
Object(_utils__WEBPACK_IMPORTED_MODULE_4__["ifMatchingAction"])(function (action) {
  return 'query' in action;
}), // Inject query parts into action for use both in `onSubKey` and reducer.
Object(_utils__WEBPACK_IMPORTED_MODULE_4__["replaceAction"])(function (action) {
  // `ifMatchingAction` still passes on initialization, where state is
  // undefined and a query is not assigned. Avoid attempting to parse
  // parts. `onSubKey` will omit by lack of `stableKey`.
  if (action.query) {
    return Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action, Object(_get_query_parts__WEBPACK_IMPORTED_MODULE_6__["default"])(action.query));
  }

  return action;
}), // Queries shape is shared, but keyed by query `stableKey` part. Original
// reducer tracks only a single query object.
Object(_utils__WEBPACK_IMPORTED_MODULE_4__["onSubKey"])('stableKey')])(function () {
  ...
  var type = action.type,
      ...
      key = _action$key === void 0 ? _entities__WEBPACK_IMPORTED_MODULE_5__["DEFAULT_ENTITY_KEY"] : _action$key;
    ...
    case 'CREATE_UNDO_LEVEL':
      ...
      if (isCreateUndoLevel) {
        ...
        if (Object.keys(action.edits).some(function (key) {
          ...
          lastEditAction = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, action, {
            edits: Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, lastEditAction && lastEditAction.edits, action.edits)
          });
        }
      }
      ...
      if (!isCreateUndoLevel && !Object.keys(action.edits).some(function (key) {
        ...
        nextState = Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(state);
        nextState.flattenedUndo = Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state.flattenedUndo, action.edits);
      ...
      if (!_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_6___default()(comparisonUndoEdits, comparisonEdits)) {
        nextState.push({
          ...
          edits: isCreateUndoLevel ? Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state.flattenedUndo, action.edits) : action.edits
        });
      }
...
getEntityRecord.shouldInvalidate = function (action, kind, name) {
  return action.type === 'RECEIVE_ITEM' && action.invalidateCache && kind === action.kind && name === action.name;
};
/**
...
/*!******************************************************!*\
  !*** ./packages/core-data/build-module/selectors.js ***!
  \******************************************************/
/*! exports provided: isRequestingEmbedPreview, getAuthors, getCurrentUser, getUserQueryResults, getEntitiesByKind, getEntity, getEntityRecord, getRawEntityRecord, getEntityRecords, getEntityRecordChangesByRecord, getEntityRecordEdits, getEntityRecordNonTransientEdits, hasEditsForEntityRecord, getEditedEntityRecord, isAutosavingEntityRecord, isSavingEntityRecord, getLastEntitySaveError, getUndoEdit, getRedoEdit, hasUndo, hasRedo, getThemeSupports, getEmbedPreview, isPreviewEmbedFallback, hasUploadPermissions, canUser, getAutosaves, getAutosave, hasFetchedAutosaves, getReferenceByDistinctEdits */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
